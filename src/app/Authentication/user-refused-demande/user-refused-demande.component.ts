...
@Component({
  selector: 'app-user-refused-demande',
  templateUrl: './user-refused-demande.component.html',
  styleUrls: ['./user-refused-demande.component.css']
})
export class UserRefusedDemandeComponent implements OnInit {
  ...
  getRefusedEventByUserId(){
    this.eventService.getRefusedEventByUserId(this.id)
    .pipe(
